...
function Overlay({show, setShow}: {show: boolean, setShow: Dispatch<SetStateAction<boolean>>}){
    ...
    return (
        <div className="fixed inset-0 z-50 bg-danse/40 w-full" style={{display: show? 'block': 'none'}} onClick={handleClose}  >
...
export default function PhotosCarousel({images, width}: {images: string[], width: number}){
